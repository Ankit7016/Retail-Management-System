...
public class UserOperations {
    ...
    public static void printUser() {
        ...
        while (new_Iterator.hasNext()) {
            Map.Entry<String, ParentUser> new_Map = (Map.Entry<String, ParentUser>) new_Iterator.next();
            ParentUser temp = new_Map.getValue();

            // Displaying HashMap
            System.out.println(new_Map.getKey() + "  fn:" + temp.getFullname() + " u:" + temp.getUsername() + " p:"
                    + temp.getPassword() + "\n");
        }
    }
